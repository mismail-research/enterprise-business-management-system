define(['plugins/router', 'services/appsecurity', 'services/errorhandler', 'services/utils','services/unitofwork'],
    function (router, appsecurity, errorhandler, utils,unitofwork) {
