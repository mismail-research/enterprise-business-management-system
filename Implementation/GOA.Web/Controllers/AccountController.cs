...
using GOA.Web.Results;
using GOA.Web.Providers;
...
namespace GOA.Web.Controllers
{
	...
	public class AccountController : ApiController
	{
		...
		public async Task<IHttpActionResult> ResendConfirmationEmail()
		{
			...
			await UserManager.SendEmailAsync(user.Id, "GOA Account Confirmation", body);
			
			return Ok();
		}
        [AllowAnonymous]
        [Route("SendMessage")]
        public async Task<IHttpActionResult> SendMessage(ContactMessage cm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            }
           await new EmailService().SendMessage(cm);
		...
		public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordBindingModel model)
		{
			if (ModelState.IsValid)
			{
				...
				await UserManager.SendEmailAsync(user.Id, "GOA Reset Password", body);
		...
		public async Task<IHttpActionResult> Register(RegisterBindingModel model)
		{
            ...
            profile.UserId = justCreatedUser.Id;
